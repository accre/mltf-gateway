...
parser = argparse.ArgumentParser(
    prog = "mltf",
    description = "Client interface to the MLTF infrastructure"
)
...
internal_parser = subparser.add_parser(
    name = "internal",
    description = "Testing/debug options, not to be used externally"
)

internal_subparser = internal_parser.add_subparsers(
    dest="sub2"
)
...
internal_payload_parser.add_argument(
    "run"
)
