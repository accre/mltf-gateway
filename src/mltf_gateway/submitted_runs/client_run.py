...
class ClientSideSubmittedRun(SubmittedRun):
    ...
    def __init__(self, adapter, run_id, gateway_id, creation_time):
    ...
    @classmethod
    def from_dict(cls, adapter, data) -> "ClientSideSubmittedRun":
        """
    ...
    def wait(self):
        ...
        return self.adapter.wait(self.gateway_id)
